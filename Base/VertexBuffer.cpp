...
namespace gfx
{
	...
	*/
	const std::vector<Vector3D<float>>& VertexBuffer::GetVertices() const
	{
	...
	*/
	...
	{
		return static_cast<unsigned>(sizeof(Vector3D<float>) * this->vertices_.size() + sizeof(int) * 3 * this->faces_.size());
	}
